...
// //           } : null,
// //           isTemporary: data.message.message_type === "file" ? false : !!data.message.base64Data, // File không temporary
// //         };
...
// //     // Xử lý khác nhau cho file và media
// //     if (mediaType === "file") {
// //       // File: Upload ngay và gửi với URL
// //       await uploadFileDirectly(file, mediaType, tempMessageId);
// //     } else {
// //       // Image/Video: Giữ nguyên logic hiện tại với base64
...
// //         uploading: true,
// //         fileName: file.name,
// //         isTemporary: false, // File không temporary
// //       };
...
// //         // Tạo message với URL ngay lập tức
// //         const fileMessage = {
// //           id: messageId,
// //           type: "sent",
// //           timestamp: new Date(),
...
// //   // Hàm upload cho image/video (giữ nguyên)
...
// //     // Hiển thị file: Luôn có URL để download ngay
// //     if (message.file) {
...
//   // Cuộn xuống cuối khi messages thay đổi (chỉ khi append, không phải prepend)
//   useEffect(() => {
...
//             return updatedMessages;
//           }
//           if (receivedMessage.timestamp > prev[prev.length - 1]?.timestamp) {
//             return [...prev, receivedMessage];
//           }
//           return prev;
//         });
...
//   // Fetch tin nhắn từ API với pagination
...
//   // Initial fetch khi friend thay đổi
//   useEffect(() => {
//     setLoading(true);
//     setIsLoadingMore(false);
//     setHasMore(true);
...
//       // Chỉ thêm tin nhắn nếu conversation_id khớp với friend.id
//       if (data.message.conversation_id !== friend.id) {
//         console.log(`[Chat] Bỏ qua tin nhắn vì conversation_id ${data.message.conversation_id} không khớp với friend.id ${friend.id}`);
//         return;
//       }
...
//           if (onUpdateChat) {
//             console.log("Gọi onUpdateChat từ receiveMessage:", friend.id, {
...
//       // Chỉ cập nhật tin nhắn nếu conversation_id khớp với friend.id
//       if (data.message.conversation_id !== friend.id) {
//         console.log(`[Chat] Bỏ qua cập nhật tin nhắn vì conversation_id ${data.message.conversation_id} không khớp với friend.id ${friend.id}`);
//         return;
//       }
